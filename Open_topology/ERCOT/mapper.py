...
df = pd.read_csv('ERCOT.csv',header=0)
crs = {'init':'epsg:4326'}
# crs = {"init": "epsg:2163"}
...
BA_choices = ['SOUTHWEST POWER POOL', 'EL PASO ELECTRIC COMPANY',
...
for n in names:
    ...
    if BA.iloc[0,nx] not in BA_choices:
        BAs.append('ELECTRIC RELIABILITY COUNCIL OF TEXAS, INC.')
    else:
...
ax.set_box_aspect(1)
ax.set_xlim(350000,550000)
ax.set_ylim([-1800000,-1600000])
plt.axis('off')
plt.savefig('HOUSTON_topology.jpg',dpi=330)
