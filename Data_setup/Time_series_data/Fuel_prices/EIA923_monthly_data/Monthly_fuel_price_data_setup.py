...
#Reading WECC BAs
BAs_df = pd.read_csv('../../BA_data/BAs.csv',header=0)
WECC_BAs = [*BAs_df['Abbreviation']]

#Reading and finding states of WECC BAs
nodes_to_BA_state = pd.read_csv('../../../10k_topology_files/nodes_to_BA_state.csv',header=0)
...
for year in years:
    ...
    #Reading data
    EIA_923 = pd.read_excel('EIA_raw_data/EIA923_{}.xlsx'.format(year),sheet_name='Page 5 Fuel Receipts and Costs',header=4)
    ...
    with pd.ExcelWriter('EIA_organized_data/{}_Fuel_Price_Data.xlsx'.format(year), engine='openpyxl') as writer:  
