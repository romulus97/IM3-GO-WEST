...
load_data = pd.read_csv('BA_raw_data/BA_load_2021_init.csv',header=0)
...
# #Fixing stable demand issue in TEPC 
load_data.reset_index(drop=True,inplace=True)
load_data.loc[1152:1500,'TEPC'] = load_data.loc[803:1151,'TEPC'].values
load_data.loc[1501:1895,'TEPC'] = load_data.loc[1896:2290,'TEPC'].values

#exporting corrected data
load_data.to_csv('BA_organized_data/BA_load_2021.csv')
