...
for year in years:
    ...
    plants = pd.read_excel('EIA_raw_data/Plant_EIA860_{}.xlsx'.format(year),header=1)
    
    #Reading EIA solar and wind data
    solar = pd.read_excel('EIA_raw_data/Solar_EIA860_{}.xlsx'.format(year),sheet_name='Operable',header=1)
    wind = pd.read_excel('EIA_raw_data/Wind_EIA860_{}.xlsx'.format(year),sheet_name='Operable',header=1)
    ...
    #Exporting results
    solar_wind_df.to_csv('EIA_organized_data/BA_solar_wind_capacity_EIA_{}.csv'.format(year))
