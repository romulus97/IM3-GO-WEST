...
for year in years:
    ...
    BA_coal_df = pd.read_excel('../Monthly_fuel_prices/{}_Fuel_Price_Data.xlsx'.format(year),sheet_name='BA_coal')
    ...
    coal_price_final_daily.to_csv('BA_coal_prices_{}.csv'.format(year),index=False)
