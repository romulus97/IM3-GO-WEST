...
BA_solar = pd.read_csv('Initial_data/BA_solar_2021_init.csv',header=0)
del BA_solar['Unnamed: 0']

BA_wind = pd.read_csv('Initial_data/BA_wind_2021_init.csv',header=0)
...
BA_wind.to_csv('Corrected_data/BA_wind_2021.csv')

BA_solar.reset_index(drop=True,inplace=True)
BA_solar.to_csv('Corrected_data/BA_solar_2021.csv')           
